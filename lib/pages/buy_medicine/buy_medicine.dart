...
import 'package:hospital_management_system/pages/buy_medicine/buy_medicine_details.dart';
                      ...
                      return ListView.builder(
                        physics: new BouncingScrollPhysics(),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>BuyMedDetails(
